// lib/screens/tutor_home_screen.dart
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData && snapshot.data!.exists) {
          ...
          if (data is Map) {
            firstName = (data['displayName'] as String?)?.split(' ').first ?? 'Tutor';
              ...
              onSubmitted: (query) {
                if (query.trim().isNotEmpty) {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => TutorBrowseProgramsScreen(
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const TutorBrowseProgramsScreen(),
                    ),
                  );
                },
                child: const Text(
              ...
              child: _buildActionTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const TutorAnnouncementsScreen(),
                    ),
                  );
                },
              ),
