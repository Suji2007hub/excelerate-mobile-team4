// lib/screens/tutor_explore_screen.dart
...
class TutorExploreScreen extends StatefulWidget {
  const TutorExploreScreen({super.key});

  @override
  State<TutorExploreScreen> createState() => _TutorExploreScreenState();
}

class _TutorExploreScreenState extends State<TutorExploreScreen> {
  ...
  Widget _buildHeader() {
    return Row(
      children: [
              // ✅ Back button - navigates to TutorHomeScreen
        MouseRegion(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => TutorProgramDetailsScreen(
                program: {
                  'id': program['id'],
                  'title': program['title'],
