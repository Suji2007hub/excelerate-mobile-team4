...
class TutorBrowseProgramsScreen extends StatefulWidget {
  final String? searchQuery;

  const TutorBrowseProgramsScreen({super.key, this.searchQuery});

  @override
  State<TutorBrowseProgramsScreen> createState() =>
    _TutorBrowseProgramsScreenState();
}

class _TutorBrowseProgramsScreenState
  extends State<TutorBrowseProgramsScreen> {
